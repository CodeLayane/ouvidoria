...
if (!empty($filtro_data_inicio)) {
    $where_conditions[] = "data_criacao >= :data_inicio";
    $params[':data_inicio'] = $filtro_data_inicio . ' 00:00:00';
}

if (!empty($filtro_data_fim)) {
    $where_conditions[] = "data_criacao <= :data_fim";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-lg-10 ms-sm-auto px-md-4 py-4 content-wrapper">
                <h2 class="mb-4"><i class="fas fa-comments"></i> Manifestações</h2>
                                ...
                                <div class="col-12 col-md-4 d-flex align-items-end mb-3">
                                    <div class="d-flex gap-2 w-100">
                                        <button type="submit" class="btn btn-primary flex-grow-1">
                                            <i class="fas fa-filter"></i> <span class="d-none d-sm-inline">Aplicar Filtros</span>
                                        </button>
                                        <a href="manifestacoes.php" class="btn btn-secondary flex-grow-1">
                                            <i class="fas fa-sync-alt"></i> <span class="d-none d-sm-inline">Limpar</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell">Mensagem</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $type_classes = [
                                                'sugestao' => 'type-sugestao',
                                                'critica' => 'type-critica',
                                                'elogio' => 'type-elogio',
                                                'reclamacao' => 'type-reclamacao'
                                            ];
                                            
                                            echo '<span class="type-icon ' . $type_classes[$manifestacao['tipo_manifestacao']] . '">' . 
                                                 $tipos_icons[$manifestacao['tipo_manifestacao']] . 
                                                 '</span>' . 
                                                 '<span class="d-none d-md-inline">' . ucfirst($manifestacao['tipo_manifestacao']) . '</span>';
                                            ?>
                                        </td>
                                        <td class="d-none d-md-table-cell"><?php echo ucfirst($manifestacao['area_relacionada']); ?></td>
                                        <td class="d-none d-sm-table-cell">
                                            <div class="message-preview">
                                                <?php echo htmlspecialchars($manifestacao['mensagem']); ?>
                                            </div>
                                        </td>
                                        <td class="d-none d-lg-table-cell"><?php echo date('d/m/Y H:i', strtotime($manifestacao['data_criacao'])); ?></td>
                                        <td class="d-none d-md-table-cell"><?php echo $manifestacao['anonimo'] ? 'Anônima' : 'Identificada'; ?></td>
                                        <td>
                                            <?php 
                                            $status_classes = [
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <nav aria-label="Paginação de manifestações">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="?pagina=<?php echo $pagina_atual - 1; ?>&status=<?php echo $filtro_status; ?>&tipo=<?php echo $filtro_tipo; ?>&area=<?php echo $filtro_area; ?>&data_inicio=<?php echo $filtro_data_inicio; ?>&data_fim=<?php echo $filtro_data_fim; ?>" aria-label="Anterior">
                                    ...
                                    <li class="page-item <?php echo $i == $pagina_atual ? 'active' : ''; ?>">
                                        <a class="page-link" href="?pagina=<?php echo $i; ?>&status=<?php echo $filtro_status; ?>&tipo=<?php echo $filtro_tipo; ?>&area=<?php echo $filtro_area; ?>&data_inicio=<?php echo $filtro_data_inicio; ?>&data_fim=<?php echo $filtro_data_fim; ?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                    <?php endfor; ?>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="?pagina=<?php echo $pagina_atual + 1; ?>&status=<?php echo $filtro_status; ?>&tipo=<?php echo $filtro_tipo; ?>&area=<?php echo $filtro_area; ?>&data_inicio=<?php echo $filtro_data_inicio; ?>&data_fim=<?php echo $filtro_data_fim; ?>" aria-label="Próximo">
